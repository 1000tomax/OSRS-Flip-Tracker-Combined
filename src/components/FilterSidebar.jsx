...
export default function FilterSidebar({
  ...
  return (
    <div
      className={`${isOpen ? 'w-80' : 'w-16'} transition-all duration-200 bg-gray-900/80 backdrop-blur-sm border-r border-gray-700 flex flex-col ${className}`}
    >
      ...
      {isOpen && <div className="flex-1 p-4 space-y-6 overflow-y-auto">{children}</div>}
    </div>
  );
}
