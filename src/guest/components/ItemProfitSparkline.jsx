 ...
 */
export default function ItemProfitSparkline({
  data = [],
  height = 28,
  stroke = '#3b82f6',
  lazy = true,
  ...
  if (!Array.isArray(data) || data.length === 0) {
    return (
      <div
        ref={containerRef}
        className="h-7 w-full bg-gray-700 rounded"
  ...
  if (!isVisible) {
    return (
      <div
        ref={containerRef}
        className="h-7 w-full bg-gray-700/70 rounded"
      ...
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={{ top: 4, bottom: 0, left: 0, right: 0 }}>
          ...
          <Tooltip
            ...
            formatter={value => [`${Number(value || 0).toLocaleString()} GP`, 'Profit']}
