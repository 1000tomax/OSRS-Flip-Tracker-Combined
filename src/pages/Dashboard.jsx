...
import FlipLogViewer from '../components/FlipLogViewer';
import DatePicker from '../components/DatePicker';
import DailySummary from '../components/DailySummary';

// Import new performance components
const PerformanceAnalysis = lazy(() => import('../components/PerformanceAnalysis'));
const ProfitVelocity = lazy(() => import('../components/ProfitVelocity'));
const WinRateChart = lazy(() => import('../components/WinRateChart'));
const FlipVolumeChart = lazy(() => import('../components/FlipVolumeChart'));
const ProfitLossChart = lazy(() => import('../components/ProfitLossChart'));
    ...
    <div className="max-w-7xl mx-auto p-8">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-4">
          <button
            onClick={() => navigate('/blocklist-generator')}
      ...
      {activeTab === 'performance' && (
        <div className="space-y-8" id="performance-section">
          <Suspense fallback={<div className="text-gray-300">Loading performance analysis…</div>}>
            ...
            <PerformanceAnalysis guestData={guestData} originalData={originalData} />
          </Suspense>
          ...
          <Suspense fallback={<div className="text-gray-300">Loading profit/loss…</div>}>
            <ProfitLossChart guestData={guestData} originalData={originalData} />
          </Suspense>

          {/* Secondary Charts Grid */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Suspense fallback={<div className="text-gray-300">Loading win rate…</div>}>
              <WinRateChart guestData={guestData} originalData={originalData} />
            </Suspense>
            <Suspense fallback={<div className="text-gray-300">Loading flip volume…</div>}>
              <FlipVolumeChart guestData={guestData} originalData={originalData} />
            </Suspense>
          </div>
        </div>
      )}
      ...
      {activeTab === 'summary' && (
        <DailySummary guestData={guestData} onDateSelect={handleDateSelect} />
      )}
    </div>
  );
}
