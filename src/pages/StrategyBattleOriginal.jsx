      ...
      <div className="space-y-2">
        {displayItems.map((item, idx) => {
          ...
          const profitSharePercent =
            totalStrategyProfit !== 0 ? (item.profit / totalStrategyProfit) * 100 : 0;
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white font-sans p-2 sm:p-4">
      <div className="bg-gray-900 border border-gray-700 rounded-2xl p-3 sm:p-6 shadow-lg max-w-full overflow-hidden">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold mb-6 text-white">
          ⚔️ Strategy Battle: Volume vs Value
        </h1>

        {/* Date Navigation Controls */}
        {summaryDates && <DateNavigation currentDate={date} basePath="/volume" />}
        ...
        {date && strategyAnalysis && (
          <div className="space-y-6">
            ...
            <div className="text-center">
              ...
              {cashStackInfo && (
                <div className="bg-gradient-to-r from-yellow-600/20 to-yellow-500/20 border border-yellow-500/30 rounded-xl p-4 mb-4 max-w-md mx-auto">
                  ...
                  <div className="text-xs text-yellow-200 space-y-1">
                    <div>
                      Gained: {formatGP(cashStackInfo.dayProfit)} GP (
                      {cashStackInfo.percentGain.toFixed(1)}%)
                    </div>
              ...
              >
                🏆 {strategyAnalysis.winner === 'volume' ? 'High Volume' : 'High Value'} Strategy
                Wins!
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <div className="text-gray-300 mt-1">
                    Flips with {HIGH_VOLUME_QUANTITY.toLocaleString()}+ items per trade. Fast-moving
                    goods like runes, arrows, and bulk commodities.
                  </div>
                </div>
                <div>
                  <div className="font-medium text-blue-400">💎 High Value Strategy</div>
                  <div className="text-gray-300 mt-1">
                    Flips with fewer than {HIGH_VALUE_QUANTITY} items per trade. Expensive items
                    like weapons, armor, and rare goods.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 border border-gray-600 rounded-xl p-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center text-sm">
                <div>
                  <div className="text-xl font-bold text-white">
                    {strategyAnalysis.totalValidFlips}
                  </div>
                ...
                <div>
                  <div className="text-xl font-bold text-gray-400">
                    {strategyAnalysis.unclassifiedFlips}
                  </div>
            ...
            <div className="bg-gradient-to-r from-purple-800/30 to-blue-800/30 border border-purple-500/30 rounded-xl p-4">
              ...
              <div className="text-sm text-gray-300 space-y-3">
                <div>
                  <strong className="text-white">Strategy Classification:</strong> Each flip is
                  automatically categorized based on quantity traded:
                  <ul className="mt-1 ml-4 space-y-1 text-xs">
                    <li>
                      • <span className="text-green-400">High Volume</span>: 1,000+ items per flip
                      (bulk commodities, runes, arrows)
                    </li>
                    <li>
                      • <span className="text-blue-400">High Value</span>: &lt;100 items per flip
                      (expensive gear, rare items)
                    </li>
                    <li>
                      • <span className="text-gray-400">Unclassified</span>: 100-999 items
                      (medium-value trades)
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  <strong className="text-white">Profit Per Hour Calculation:</strong> For each
                ...
                <div>
                  <strong className="text-white">What the Data Shows:</strong> The detailed
                  breakdown reveals which specific items drive each strategy's performance, how much
                  time was invested in each, and their individual hourly rates. This transparency
                  helps you understand exactly what makes each strategy profitable on any given day.
                </div>
